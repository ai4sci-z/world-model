...
type FCUControllerSpec struct {
	...
	MaxLandingTiltDeg               float64
	MaxLandingAltitudeDisagreementM float64
	MaxPreLandXYSpeedMPS            float64
	MaxPreLandTiltDeg               float64
	MaxPreLandStabilizationSec      float64
...
func DefaultFCUControllerSpec() FCUControllerSpec {
	return FCUControllerSpec{
		...
		MaxLandingTiltDeg:               35.0,
		MaxLandingAltitudeDisagreementM: 1.0,
		MaxPreLandXYSpeedMPS:            0.20,
		MaxPreLandTiltDeg:               8.0,
		MaxPreLandStabilizationSec:      8.0,
...
func FCUControllerRuntimeScript(spec FCUControllerSpec, durationSec float64, runtimeTimeoutSec ...float64) (string, error) {
	...
	payload := map[string]any{
		...
		"max_landing_tilt_deg":                spec.MaxLandingTiltDeg,
		"max_landing_altitude_disagreement_m": spec.MaxLandingAltitudeDisagreementM,
		"max_pre_land_xy_speed_mps":           spec.MaxPreLandXYSpeedMPS,
		"max_pre_land_tilt_deg":               spec.MaxPreLandTiltDeg,
		"max_pre_land_stabilization_sec":      spec.MaxPreLandStabilizationSec,
